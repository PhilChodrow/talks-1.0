...
[Real talk: this was a reliable source of low-risk theory problems as I established my career.]{.footnote .fragment fragment-index=2}
...
|          	| $n$    	| $m$    	| HCM <br>11 pars   | NHP <br>?? pars    | LHP <br>$10^6$ pars       	|
|:----------|--------:|--------:|------------:|--------:|------------:|
...
[[**Violet Ross**]{.alert} (CU Boulder)]{.absolute top=420 left=200}
